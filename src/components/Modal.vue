                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                                <button @click="modal.handleClickModal" type="button"
                                    class="w-full rounded bg-gray-600 p-3 font-bold uppercase text-white shadow hover:bg-gray-500">
                                    Cerrar
                                </button>

                                <button @click="favoritos.handleClickFavorito" class="w-full rounded bg-orange-600 p-3 font-bold uppercase text-white shadow hover:bg-orange-500" type="button">
                                    {{ modal.textoBoton }}
                                </button>
